<template>
  <div class="col-sm">
    ...
    <b-form @submit="onSubmit" v-if="!loading">
      ...
      <b-form-group id="convertFile"
            label="Select the file you want to convert:"
            label-for="cconvertFileInput">
        <b-form-file id="cconvertFileInput" v-model="form.file" placeholder="Choose a file..." accept="image/*"></b-form-file>
      </b-form-group>
